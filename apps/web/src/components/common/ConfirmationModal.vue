            ...
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div class="sm:flex sm:items-start">
                ...
                <div :class="iconContainerClasses">
                  <ExclamationTriangleIcon v-if="variant === 'warning'" :class="iconClasses" />
                  <XCircleIcon v-else-if="variant === 'danger'" :class="iconClasses" />
                  <CheckCircleIcon v-else-if="variant === 'success'" :class="iconClasses" />
                  <InformationCircleIcon v-else :class="iconClasses" />
                </div>
