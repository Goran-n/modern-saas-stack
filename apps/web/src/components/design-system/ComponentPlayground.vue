    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="text-neutral-600">
          Component library and design system playground
        </p>
      </div>
      ...
      <div class="space-y-12">
        ...
        <section>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Primary Colors -->
            <div>
              <h3 class="text-lg font-medium text-neutral-800 mb-3">
                Primary
              </h3>
              <div class="space-y-2">
                <div
                  ...
                  class="h-10 rounded flex items-center px-3 text-sm font-medium"
                  :class="shade >= 600 ? 'text-white' : 'text-neutral-900'"
                >
                  primary-{{ shade }}
                </div>
              </div>
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <div class="text-sm text-neutral-600">
              Small text - Regular sm
            </div>
            <div class="text-2xs text-neutral-500">
              Extra small text - Regular 2xs
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="space-y-8">
            <div>
              <h3 class="text-lg font-medium text-neutral-800 mb-4">
                Variants
              </h3>
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-4">
                ...
                <BaseButton :leading-icon="PlusIcon">
                  With Icon
                </BaseButton>
                <BaseButton
                  icon-only
