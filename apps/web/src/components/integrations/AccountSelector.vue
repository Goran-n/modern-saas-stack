<template>
  <div class="space-y-6">
    <div>
      <h4 class="text-lg font-medium text-neutral-900 mb-2">Select Organisation</h4>
    ...
    <div v-if="loading" class="space-y-4">
      <div class="animate-pulse">
        ...
        <div class="space-y-3">
          <div v-for="i in 3" :key="i" class="border border-neutral-200 rounded-lg p-4">
    ...
    <!-- Organisation list -->
    <div v-else-if="organisations && organisations.length > 0" class="space-y-3">
      <div
        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <div class="flex items-center">
              <h5 class="text-sm font-medium text-neutral-900">{{ organisation.name }}</h5>
              <span
            ...
            <p v-if="organisation.currency" class="text-xs text-neutral-500 mt-1">
    ...
    <!-- Error state -->
    <div v-else-if="error && !loading" class="text-center py-8">
      <div class="mx-auto h-12 w-12 text-red-400 mb-4">
        <ExclamationTriangleIcon class="w-full h-full" />
      </div>
      <h5 class="text-sm font-medium text-neutral-900 mb-2">Error loading organisations</h5>
      <p class="text-sm text-neutral-500">{{ error }}</p>
    </div>

    <!-- Empty state -->
    <div v-else-if="!loading && (!organisations || organisations.length === 0)" class="text-center py-8">
      <div class="mx-auto h-12 w-12 text-neutral-400 mb-4">
        <ExclamationTriangleIcon class="w-full h-full" />
      </div>
      <h5 class="text-sm font-medium text-neutral-900 mb-2">No organisations found</h5>
