  ...
  <div class="container mx-auto px-4 py-8">
    ...
    >
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <!-- Addresses -->
        <section
          v-if="contact.primaryAddress || contact.billingAddress || contact.shippingAddress" 
          ...
          <div class="space-y-4">
            ...
            <div v-if="contact.primaryAddress">
              ...
              <address class="text-sm text-gray-600 not-italic">
                <div v-if="contact.primaryAddress.line1">
                  {{ contact.primaryAddress.line1 }}
                </div>
                <div v-if="contact.primaryAddress.line2">
                ...
                <div v-if="contact.primaryAddress.country">
            ...
            <div v-if="contact.billingAddress && JSON.stringify(contact.billingAddress) !== JSON.stringify(contact.primaryAddress)">
              ...
              <address class="text-sm text-gray-600 not-italic">
                <div v-if="contact.billingAddress.line1">
                  {{ contact.billingAddress.line1 }}
                </div>
                <div v-if="contact.billingAddress.line2">
                ...
                <div v-if="contact.billingAddress.country">
        ...
        <!-- Tax Information -->
        <section
          v-if="contact.taxNumber || contact.vatNumber || contact.companyNumber" 
          class="bg-white rounded-lg shadow p-6"
        >
          <h2 class="text-lg font-semibold text-gray-900 mb-4">
            Tax & Legal
      ...
      <div class="space-y-8">
        ...
        <!-- Payment Terms -->
        <section
          v-if="contact.defaultPaymentTerms || contact.defaultPaymentMethod" 
          class="bg-white rounded-lg shadow p-6"
        >
          <h2 class="text-lg font-semibold text-gray-900 mb-4">
            Payment Details
