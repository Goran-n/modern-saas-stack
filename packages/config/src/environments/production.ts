...
export const productionConfigSchema = z
  .object({
    ...
    SUPABASE_URL: z
      .string()
      .url()
      .min(1, "SUPABASE_URL is required in production"),
    SUPABASE_ANON_KEY: z
      .string()
      .min(1, "SUPABASE_ANON_KEY is required in production"),
    SUPABASE_SERVICE_KEY: z
      .string()
      .min(1, "SUPABASE_SERVICE_KEY is recommended in production")
      .optional(),
  ...
  .merge(emailSchema) // Email is required in production
