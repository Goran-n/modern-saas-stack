    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            {inviterName} has invited you to join the <strong>{tenantName}</strong> team on Figgy, 
            the intelligent accounting assistant that makes managing your finances easier.
          </Text>
          ...
          <Text style={footer}>
            This invitation will expire on {formattedDate}.
