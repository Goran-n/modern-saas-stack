...
export class ScoringUtils {
   ...
   */
  static calculateVendorSimilarity(name1: string | null | undefined, name2: string | null | undefined): number {
   ...
   */
  static calculateDateProximity(date1: Date | string | null | undefined, date2: Date | string | null | undefined, toleranceDays: number = 1): number {
   ...
   */
  static calculateAmountMatch(amount1: number | string | null | undefined, amount2: number | string | null | undefined, tolerance: number = 0.01): number {
    if (amount1 === null || amount1 === undefined || amount2 === null || amount2 === undefined) return 0;
   ...
   */
  static calculateInvoiceNumberMatch(num1: string | null | undefined, num2: string | null | undefined): number {
