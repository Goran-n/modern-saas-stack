...
export const ERROR_MESSAGES = {
  NO_CONTENT_OR_ATTACHMENTS: 'Message must contain either text content or attachments',
  ...
  SLACK_MISSING_WORKSPACE: 'Slack message must include workspace ID in metadata',
